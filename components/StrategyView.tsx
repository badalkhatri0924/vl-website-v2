...
const StrategyView: React.FC = () => {
  const steps = [
    ...
    { title: "Architecture", desc: "Zero-trust blueprints and Versionlabs data mapping." },
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mb-32">
          ...
          <h2 className="text-6xl md:text-8xl font-display font-black text-obsidian-900 leading-[0.9] tracking-tighter mb-12">
            The <span className="text-accent italic font-light">Versionlabs</span> <br />
            Methodology.
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-slate-200 mb-40 border border-slate-200 rounded-sm overflow-hidden">
           {[
             { t: "Versionlabs Sovereignty", d: "Ensuring national data stays within national borders through air-gapped ready architecture." },
