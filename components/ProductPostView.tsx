          ...
          <div className="max-w-7xl mx-auto">
            ...
            {product.link && (
              <a
                ...
                className="inline-flex items-center space-x-3 px-6 py-4 bg-white/10 border border-white/40 text-white hover:bg-accent hover:border-accent transition-all duration-300 group/btn text-sm font-black uppercase tracking-ultra"
              >
